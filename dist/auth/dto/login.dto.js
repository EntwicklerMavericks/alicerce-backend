...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'eduardo@alicerce.com', description: 'E-mail cadastrado' }),
    (0, class_validator_1.IsEmail)({}, { message: 'E-mail inválido' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'O e-mail é obrigatório' }),
    __metadata("design:type", String)
], LoginDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '123mudar', description: 'Senha de acesso' }),
