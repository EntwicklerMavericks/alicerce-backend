...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registra um novo usuário e cria seu Workspace Principal' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Usuário e workspace criados com sucesso' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Autentica um usuário com e-mail e senha' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Autenticado com sucesso' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Renova a sessão enviando o Refresh Token (com Rotação)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Novo Access Token e Refresh Token gerados' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Invalida o Refresh Token ativo' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [refresh_dto_1.RefreshTokenDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "eu", null);
