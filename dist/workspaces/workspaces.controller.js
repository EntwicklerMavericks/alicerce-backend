...
let WorkspacesController = class WorkspacesController {
    ...
    async listarMeusWorkspaces(usuarioId) {
        return this.workspacesService.listarWorkspacesDoUsuario(usuarioId);
    }
    async obterWorkspace(workspaceId, usuarioId) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lista os workspaces pertencentes ao usuário logado' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('sub')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WorkspacesController.prototype, "listarMeusWorkspaces", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Retorna detalhes de um workspace específico' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('sub')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], WorkspacesController.prototype, "obterWorkspace", null);
