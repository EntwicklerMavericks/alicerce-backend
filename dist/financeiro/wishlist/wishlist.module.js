...
exports.WishlistModule = WishlistModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [wishlist_service_1.WishlistService, wishlist_analytics_read_model_service_1.WishlistAnalyticsReadModelService],
        exports: [wishlist_service_1.WishlistService, wishlist_analytics_read_model_service_1.WishlistAnalyticsReadModelService],
    })
], WishlistModule);
