...
export declare class ProjetosController {
    ...
    criarEtapa(workspaceId: string, id: string, dto: CriarEtapaProjetoDto): Promise<import("./read-models/projetos-read-model.service").ProjetoConsolidadoResult>;
    reordenarEtapas(workspaceId: string, id: string, dto: ReordenarEtapasDto): Promise<import("./read-models/projetos-read-model.service").ProjetoConsolidadoResult>;
    vincularItemEtapa(workspaceId: string, id: string, etapaId: string, dto: VincularItemProjetoDto): Promise<import("./read-models/projetos-read-model.service").ProjetoConsolidadoResult>;
